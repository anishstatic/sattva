...
import { SquarePen, Hash, Image, Eraser, Scissors, FileText, ImageUpscale, BookOpenCheck, GitPullRequest  } from 'lucide-react'
...
export const AiToolsData = [
    ...
    {
        title: 'AI Dictionary',
        description: 'AI Dictionary to find the meaning of any word in simple language',
        Icon: BookOpenCheck,
        bg: { from: '#3F2B96', to: '#A8C0FF' },
        path: '/ai/ai-dictionary'
    },
